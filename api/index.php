        ...
        'formulaBlocks' => [
            [
                ...
                'lines' => [
                    ...
                    'Wetted perimeter P = 50.62 m',
                    'Bed gradient S = 1 / 246.57',
                    'Value of rugosity coefficient N = 0.030',
                    'Hydraulic mean depth R = A / P',
                    'R = 47.47 / 50.62 = 0.938 m',
                    'V = 1/N x R^(2/3) x sqrt(S)',
                    'V = 1/0.030 x (0.938)^(2/3) x sqrt(1/246.57)',
                    'V = 2.0338 m/sec',
                    'Q = A x V = 47.47 x 2.0338 = 96.54 Cumecs',
                ],
            ],
            [
                ...
                'lines' => [
                    ...
                    'Intercepted catchment area = 0.00 Sq.Km',
                    'Net catchment area A = 5.37 Sq.Km',
                    'Q = C x sqrt(A)',
                    'Q = 54.96 x sqrt(5.37)',
                    'Q = 127.36 Cumecs = 4498.36 Cusecs',
                    'Flood lift H = (Q / (1.704 x L))^(2/3)',
                    'H = (127.36 / (1.704 x 20.00))^(2/3) = 2.41 m',
                    'Adopt flood lift = 0.90 m as per provided crest condition',
                ],
            ],
            [
                'title' => 'Afflux Calculation',
                'lines' => [
                    'Obstruction area = 1 x 20 x 0.69 - 2 x 2 x 1.50 + 0 x 20 x 0',
                    'Obstruction area = 13.75 - 6.00 = 7.75 Sqm',
                    'Flowing area = 47.47 - 7.75 = 39.72 Sqm',
                    'h = V^2 / 17.85 x (A / a - 1) + 0.0152 x (A / a - 1)',
                    'h = 4.14 / 17.85 x (47.47 / 39.72 - 1) + 0.0152 x (47.47 / 39.72 - 1)',
                    'Molesworth afflux h = 0.048 m',
                    'Say afflux = 0.050 m',
                    'AHFL = 100.050 m',
                ],
            ],
